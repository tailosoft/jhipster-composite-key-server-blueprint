...
public class TaskCommentResource {
    ...
    public ResponseEntity<List<TaskCommentDTO>> getAllTaskComments(TaskCommentCriteria criteria) {
        log.debug("REST request to get TaskComments by criteria: {}", criteria);
        List<TaskCommentDTO> entityList = taskCommentQueryService.findByCriteria(criteria);
